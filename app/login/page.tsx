        ...
        <div className="rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-black p-8 text-center">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full inline-flex h-12 items-center justify-center gap-2 rounded-lg bg-foreground px-5 text-base font-medium text-background transition-colors hover:bg-[#383838] dark:hover:bg-[#ccc]"
            >
